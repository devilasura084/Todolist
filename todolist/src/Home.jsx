...
function Home() {
  ...
  return (
    <div className='home'>
        <h2 style={{fontSize:50,fontFamily:"cursive"}}>Todo List</h2>
        <Create/>
        {
            todos.length === 0?
            <div><h2 style={{fontFamily:"cursive"}}>No todos</h2></div>:
            todos.map(todo=>(
                <div className='task'>
                  ...
                  <p style={{fontFamily:"cursive",fontSize:30}} className={todo.done?"line_through":""}>{todo.task}</p>
                  <div>
